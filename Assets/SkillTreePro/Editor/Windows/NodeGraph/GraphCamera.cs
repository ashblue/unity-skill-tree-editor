...
namespace Adnc.SkillTreePro {
	public class GraphCamera {
		...
		public Vector2 Center {
			get {
				return new Vector2(viewportSize / 2, viewportSize / 2);
			}
		}
...
//			Debug.LogFormat("mouse: {0}, {1}; offset: {2}, {3}; viewportSize: {4};", 
//				mouse.x, mouse.y, offset.x, offset.y, viewportSize); 
		...
		public void Reset () {
			...
			if (Wm.Win != null) {
				offset.x -= (Wm.Win.position.width - Wm.Win.sidebarWidth) / 2f;
				offset.y -= 20f;
			}
